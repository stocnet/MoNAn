...
This is version 1.0.0 of MoNAn. This update includes many changes, including
some that mean old code written for older versions will not work anymore!
...
We are currently (Mar 2024) on version 1.0.0 on github. 

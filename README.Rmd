...
Nevertheless, the package and the documentation might still have bugs or errors,
or you might
...
We are currently (Feb 2024) on version 0.2.0 on github 
version 0.1.3 was released to CRAN in Feb 2024.
...
We combine the data objects into the process state, i.e., a MoNAn object that stores all information about the data that will be used in the estimation later. Here we also need to specify what will be the outcome variable to be modelled in the analysis.
...
We create a cache (a necessary object used in the estimation of the model). In case variables of the individuals in the data are included in the state (here: "sex"), they need to be explicitly mentioned in the creation of the cache under "resourceCovariates".

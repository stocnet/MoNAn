...
The example case is using synthetic data that represents mobility of individuals between organisations. The artificial data includes an edgelist, i.e. a list of origins and destinations of individuals.
